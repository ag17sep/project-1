...
while(rs.next())
{
		...
		if(s2.indexOf(email)>=0&&(rs.getString("desrc")!=null||rs.getString("loc")!=null))
		{
			session.setAttribute("newemail",s2);
		%>
			<td width="10%" ><%=i%></td>
			<td width="60%"><%=rs.getString("descr")%></td>
			<td width="10%" ><%=rs.getString("rew")%></td>
			<td width="10%" ><a href="showdetails/index.jsp">see more</a></td>
			<td width="10%" ><a href="delete1.jsp">Delete</a></td>	</tr>
		<%
			k++;
		}
	i++;
...
if(k==0)
{
	%>
	<tr >
			<td colspan="5" align="center"><strong>No Items matched!!</strong></td></tr>
