...
<!-- //custom-theme -->
<link href="lostandfont/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="lostandfont/css/style.css" rel="stylesheet" type="text/css" media="all" />
<link rel="stylesheet" type="text/css" href="lostandfont/css/style3.css" /><!--Banner Text-->
<link rel="stylesheet" type="text/css" href="lostandfont/css/team.css" /><!--Banner Text-->
<link rel="stylesheet" href="lostandfont/css/lost and found.css">
<!-- font-awesome-icons -->
<link href="lostandfont/css/font-awesome.css" rel="stylesheet">
<!-- //font-awesome-icons -->
...
<div class="header">
		...
		<div class="w3ls_agile_header_inner">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.html"><i class="fa fa-tint" aria-hidden="true"></i>SITE NAME<span>site name</span> </a></h1>
				</div>
				<!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--juliet">
						<ul class="nav navbar-nav">
							<li class="active"><a href="enter.html">Home</a></li>
							<li><a href="lostmainpage.jsp">Lost</a></li>
							<li><a href="foundmainpage.jsp">Found</a></li>
							<li><a href="#">Police Station</a></li>
							<li><a href="#">Criminal Information</a></li>
  ...
  <form action="lost.jsp">
  <button type="submit" class="btn btn-primary btn-lg add">Add</button>
  </form>

  <form action="show.jsp">
  <button type="submit" class="btn btn-primary btn-lg add1">See yours..</button>
  </form>
  <br><br><br><br><br>
...
while(rs.next())
{
	...
	{
		String s2=rs.getString("loc"),s3=rs.getString("rew");
		if(rs.getString("rew")==null)
		{
			s3="NA";
		}
		if(s2.indexOf(str[j])>=0)
		{
			session.setAttribute("newemail",rs.getString("email"));
			
		%>
			<td width="10%" ><%=i%></td>
			<td width="70%"><%=rs.getString("descr")%></td>
			<td width="10%" ><%=s3%></td>
			<td width="10%" ><a href="showdetails/index1.jsp">see more</a></td>	</tr>
		<%
		k++;
		break;
		}
...
if(k==0)
{
	%>
	<tr >
			<td colspan="4" align="center"><strong>No Items matched!!</strong></td></tr>
