...
<body>
<!-- banner -->
<%session.setAttribute("val","found");
 %>
...
<div class="header">
		...
		<div class="w3ls_agile_header_inner">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="#"><i class="fa fa-tint" aria-hidden="true"></i>SITE NAME<span>site name</span> </a></h1>
				</div>
  ...
  <form action="search.jsp">
    <input type="text" name="search" placeholder="Search a location">
...
<%
		...
		while(rs.next())
		{
			...
			<td><%=rs.getString("rew")%></td>
			<td><a href="showdetails/index.jsp">see more</a></td>
			</tr>
			<%
			i++;
			}
		...
		if(i==1)
		{
			%>
	<tr >
			<td colspan="4" align="center"><strong>No Recent Activity!!</strong></td></tr>
